  ...
  return (
    <div>
      ...
      <Container className="min-h-screen flex flex-col items-center justify-center">
        ...
        <form
          onSubmit={onSignup}
          className="bg-white/80 shadow w-full sm:w-2/3 md:w-1/2 px-4 py-2 rounded flex flex-col gap-3 mt-6 border border-purple-400"
        >
          ...
          <button
            type="submit"
            className="bg-purple-500/90 text-lg font-semibold text-white rounded py-1 cursor-pointer"
          >
            Create Account
          </button>
        </form>
